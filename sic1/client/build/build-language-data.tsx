...
import en from "./language-data-en";
...
outputFile("ts/language-data-en.ts", `// Automatically generated by build-language-data.ts
export default ${readFileSync("content/messages-compiled/en.json", { encoding: "utf8" })};
`);
